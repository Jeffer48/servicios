<nav class="navbar" style="background-color: #6A0F49; height: 100%;">
    <div class="nav_container">
        ...
        <div style="align-self: center;">
            <svg id="btn-show-modal" style="margin: 0 0.5rem;" xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-broadcast" viewBox="0 0 16 16">
