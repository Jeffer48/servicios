...
<div class="container" id="form_container">
    ...
    <form class="principal_form">
        <div class="row mb-3">
            <label class="col-sm-2 input-label">Fecha</label>
            <div class="col-sm-10">
            <input type="datetime-local" class="form-control" id="input_date">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 input-label">Área</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="input_area">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 input-label">Unidad</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="input_unit">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 input-label">Incidente</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="input_incident">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-2 input-label">Ubicación</label>
            <div class="col-sm-10">
