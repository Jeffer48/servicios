...
<div class="table-container">
    <h1 style="margin: 2rem; text-align: center;">TABLA DE PERSONAL</h1>
            ...
            @foreach($personal as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn-no-style" onclick="btnBorrar({{$item->id}},'personal')">
                        ...
                        @else
                        <button class="btn-no-style" onclick="btnActivar({{$item->id}},'personal')">
