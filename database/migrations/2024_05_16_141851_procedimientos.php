    ...
    public function up(): void
    {
        ...
        begin
	        ...
	        set @num := (
	        	...
	        	from folios f 
	        	where f.id_area = area and f.anio = @anio
	        );
	        ...
	        insert into folios(id_area,actual_num,anio,folio,created_at,updated_at,deleted_at) values
	        (area,@num,@anio,@folio,now(),now(),null);
